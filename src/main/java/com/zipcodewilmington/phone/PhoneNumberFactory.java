...
public final class PhoneNumberFactory {
    ...
    private static PhoneNumber createRandomPhoneNumber() throws InvalidPhoneNumberFormatException {
       int areaCode =  RandomNumberFactory.createInteger(123, 567);
       int centralOfficeCode = RandomNumberFactory.createInteger(123, 567);
       int phoneLineCode = RandomNumberFactory.createInteger(1231, 5679);
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode)  {
        String fullNum ="("  + areaCode + ")-" + centralOfficeCode +"-" + phoneLineCode;
        try {
            return createPhoneNumber(fullNum);
